                ...
                <div className="py-1 px-2">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      addToast('Switched to Super Admin role', 'info');
                    }}
                    className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-body-sm text-left transition-colors ${
                      currentUser?.role === 'admin' ? 'bg-secondary-container text-on-secondary-container font-semibold' : 'hover:bg-surface-container-high text-on-surface'
                    }`}
                  >
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      addToast('Switched to Main Gate Guard role', 'info');
                    }}
                    className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-body-sm text-left transition-colors ${
                      currentUser?.role === 'guard' ? 'bg-secondary-container text-on-secondary-container font-semibold' : 'hover:bg-surface-container-high text-on-surface'
                    }`}
                  >
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      addToast('Switched to Field Supervisor role', 'info');
                    }}
                    className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-body-sm text-left transition-colors ${
                      currentUser?.role === 'supervisor' ? 'bg-secondary-container text-on-secondary-container font-semibold' : 'hover:bg-surface-container-high text-on-surface'
                    }`}
                  >
