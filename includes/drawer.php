<?php
/**
 * Shared Mobile Drawer Navigation Include
 * Mirrors the sidebar for small screen devices and responsive mobile layouts.
 */
...
?>
<div class="dion-drawer-backdrop" id="drawer-backdrop"></div>
<aside class="dion-drawer" id="mobile-drawer" aria-hidden="true">
    <div class="drawer-header">
        <div class="brand-wrapper">
            <img src="/public/assets/logo.svg" alt="Dion Security Logo" class="drawer-logo">
            <span class="brand-text">DION SECURITY</span>
        </div>
        <button type="button" class="drawer-close-btn" id="drawer-close-btn" aria-label="Close navigation drawer">
        ...
        <?php if ($currentUser): ?>
            <div class="drawer-user-info">
                ...
                <div class="user-details">
                    <div class="user-name"><?= htmlspecialchars($currentUser['name'] ?? '', ENT_QUOTES, 'UTF-8') ?></div>
                    <div class="user-role-badge role-<?= htmlspecialchars(strtolower($currentRole), ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="drawer-footer">
        <?php if ($currentUser): ?>
            <button type="button" class="btn btn-outline btn-block drawer-logout-btn" id="drawer-logout-btn">
