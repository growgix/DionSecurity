...
-- ------------------------------------------------------------------------------
-- 1. System Users (8 records)
-- Note: 'USR-ADMIN-01' is omitted as it already exists in the target database.
-- Using INSERT IGNORE to prevent duplicate key conflicts.
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO users (id, name, email, role, station, status, last_login, avatar, phone) VALUES
...
-- ------------------------------------------------------------------------------
-- 2. Estate Blocks (6 records)
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO blocks (id, name, floors, total_units, occupied_units, security_officer, status) VALUES
...
-- ------------------------------------------------------------------------------
-- 3. Housing Units Sample (13 records)
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO houses (id, unit_number, block_id, block_name, floor, type, resident_name, resident_phone, parking_slot, intercom, status, vehicles) VALUES
...
-- ------------------------------------------------------------------------------
-- 4. Verified Residents (8 records)
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO residents (id, name, unit_number, block_name, category, phone, email, since, status, rfid_tag, family_count, vehicles, avatar) VALUES
...
-- ------------------------------------------------------------------------------
-- 5. Family Members (5 records)
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO family_members (id, resident_id, resident_name, unit_number, name, relation, phone, rfid_tag, status) VALUES
...
-- ------------------------------------------------------------------------------
-- 6. Workforce Employees (12 records)
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO employees (id, name, badge_no, role, department, shift, assigned_location, status, daily_wage, monthly_wage, phone, aadhaar, rating, tasks_completed, joining_date, avatar, today_attendance) VALUES
('WRK-1001', 'Ramesh Kumar', 'DION-E101', 'Patrol Guard Level 1', 'Security & Surveillance', 'Morning (06:00 - 14:00)', 'Block A & B Service Bay', 'present', 850.00, 22100.00, '+91 98765 43210', 'XXXX-XXXX-4512', 4.9, 142, 'Jan 15, 2023', 'RK', '{"inTime": "05:52 AM", "outTime": "—", "gate": "Gate 01", "status": "present"}'),
('WRK-1002', 'Abdul Karim', 'DION-E102', 'Senior Electrician', 'Facilities & Engineering', 'Morning (06:00 - 14:00)', 'Basement Level -1 Pump Room', 'present', 1100.00, 28600.00, '+91 98765 43211', 'XXXX-XXXX-8921', 4.8, 218, 'Nov 10, 2022', 'AK', '{"inTime": "05:58 AM", "outTime": "—", "gate": "Gate 02", "status": "present"}'),
('WRK-1003', 'Suresh Yadav', 'DION-E103', 'Perimeter Boom Guard', 'Security & Surveillance', 'Morning (06:00 - 14:00)', 'Main Gate 01 Boom Barrier', 'present', 850.00, 22100.00, '+91 98765 43212', 'XXXX-XXXX-3341', 4.7, 98, 'Feb 01, 2024', 'SY', '{"inTime": "05:45 AM", "outTime": "—", "gate": "Gate 01", "status": "present"}'),
('WRK-1004', 'Mahesh Patil', 'DION-E104', 'Plumbing Technician', 'Facilities & Engineering', 'Morning (06:00 - 14:00)', 'Block C & D Riser Shafts', 'present', 1050.00, 27300.00, '+91 98765 43213', 'XXXX-XXXX-7729', 4.6, 174, 'Aug 20, 2023', 'MP', '{"inTime": "06:02 AM", "outTime": "—", "gate": "Gate 02", "status": "present"}'),
('WRK-1005', 'Dinesh Rawat', 'DION-E105', 'Housekeeping Supervisor', 'Housekeeping & Sanitization', 'Morning (06:00 - 14:00)', 'Central Lobby & Club', 'present', 950.00, 24700.00, '+91 98765 43214', 'XXXX-XXXX-1190', 4.9, 310, 'May 12, 2022', 'DR', '{"inTime": "05:50 AM", "outTime": "—", "gate": "Gate 01", "status": "present"}'),
('WRK-1006', 'Kishan Lal', 'DION-E106', 'Head Horticulturalist', 'Landscaping & Horticulture', 'Morning (06:00 - 14:00)', 'North Garden Parkway', 'present', 900.00, 23400.00, '+91 98765 43215', 'XXXX-XXXX-6602', 4.8, 88, 'Sep 05, 2023', 'KL', '{"inTime": "06:10 AM", "outTime": "—", "gate": "Gate 04", "status": "present"}'),
('WRK-1007', 'Sunil Pawar', 'DION-E107', 'CCTV Monitoring Officer', 'Security & Surveillance', 'Morning (06:00 - 14:00)', 'Central Surveillance Room', 'present', 1000.00, 26000.00, '+91 98765 43216', 'XXXX-XXXX-9934', 4.9, 412, 'Jan 02, 2023', 'SP', '{"inTime": "05:48 AM", "outTime": "—", "gate": "Gate 01", "status": "present"}'),
('WRK-1008', 'Vikram Shinde', 'DION-E108', 'Night Patrol Lead', 'Security & Surveillance', 'Night (22:00 - 06:00)', 'Perimeter Boundary Wall', 'absent', 950.00, 24700.00, '+91 98765 43217', 'XXXX-XXXX-4419', 4.5, 76, 'Dec 18, 2023', 'VS', '{"inTime": "—", "outTime": "—", "gate": "—", "status": "absent"}'),
('WRK-1009', 'Anand Kulkarni', 'DION-E109', 'HVAC Technician', 'Facilities & Engineering', 'Morning (06:00 - 14:00)', 'Tower A Chiller Plant', 'late', 1150.00, 29900.00, '+91 98765 43218', 'XXXX-XXXX-2281', 4.7, 134, 'Mar 15, 2023', 'AK', '{"inTime": "06:28 AM", "outTime": "—", "gate": "Gate 02", "status": "late"}'),
('WRK-1010', 'Prakash Jadhav', 'DION-E110', 'Sanitization Aide', 'Housekeeping & Sanitization', 'Morning (06:00 - 14:00)', 'Block E & F Corridors', 'leave', 800.00, 20800.00, '+91 98765 43219', 'XXXX-XXXX-5543', 4.6, 92, 'Jul 08, 2023', 'PJ', '{"inTime": "—", "outTime": "—", "gate": "—", "status": "leave"}'),
('WRK-1011', 'Bhagwan Das', 'DION-E111', 'Landscape Maintenance', 'Landscaping & Horticulture', 'Morning (06:00 - 14:00)', 'Sovereign Boulevard Lawns', 'present', 850.00, 22100.00, '+91 98765 43220', 'XXXX-XXXX-7712', 4.8, 64, 'Oct 11, 2023', 'BD', '{"inTime": "05:55 AM", "outTime": "—", "gate": "Gate 04", "status": "present"}'),
('WRK-1012', 'Omkar Rane', 'DION-E112', 'Turnstile Gate Officer', 'Security & Surveillance', 'Morning (06:00 - 14:00)', 'East Gate 02 Turnstiles', 'present', 850.00, 22100.00, '+91 98765 43221', 'XXXX-XXXX-9981', 4.7, 85, 'Apr 19, 2023', 'OR', '{"inTime": "05:51 AM", "outTime": "—", "gate": "Gate 02", "status": "present"}');

-- ------------------------------------------------------------------------------
-- 7. Visitors & Passes (6 records)
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO visitors (id, name, avatar, phone, category, host_resident, host_unit, vehicle_number, purpose, gate, guard_id, entry_time, exit_time, duration, badge_number, status, pre_approved, arrival_code) VALUES
...
-- ------------------------------------------------------------------------------
-- 8. Gate Logs (6 records)
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO gate_logs (id, timestamp, type, person, category, destination, vehicle, gate, guard, status) VALUES
...
-- ------------------------------------------------------------------------------
-- 9. Tasks & Work Orders (5 records)
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO tasks (id, title, description, category, priority, assigned_to_id, assigned_to_name, assigned_role, location, due_date, created_at, completed_at, verified_by, status) VALUES
...
-- ------------------------------------------------------------------------------
-- 10. Task Remarks (4 records)
-- Explicit IDs included to maintain sequence and cross-reference integrity
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO task_remarks (id, task_id, author, time, text) VALUES
...
-- ------------------------------------------------------------------------------
-- 11. Payments & Wage Vouchers (4 records)
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO payments (id, reference_no, employee_id, employee_name, amount, type, mode, payment_date, status, remarks) VALUES
('PAY-901', 'VCH-2026-0901', 'WRK-1001', 'Ramesh Kumar', 22100.00, 'Monthly Salary', 'NEFT / Direct Bank', 'Sep 01, 2026', 'paid', 'August 2026 Monthly Full Cycle Settlement'),
('PAY-902', 'VCH-2026-0902', 'WRK-1002', 'Abdul Karim', 28600.00, 'Monthly Salary', 'NEFT / Direct Bank', 'Sep 01, 2026', 'paid', 'August 2026 Monthly Full Cycle Settlement'),
('PAY-903', 'VCH-2026-0903', 'WRK-1004', 'Mahesh Patil', 5000.00, 'Wage Advance', 'IMPS Instant', 'Sep 02, 2026', 'paid', 'Mid-cycle emergency draw approved by Supervisor'),
('PAY-904', 'VCH-2026-0904', 'WRK-1007', 'Sunil Pawar', 3200.00, 'Overtime Allowance', 'NEFT / Direct Bank', 'Sep 01, 2026', 'paid', 'Night surveillance coverage overtime (16 hrs)');

-- ------------------------------------------------------------------------------
-- 12. Forensic Audit Logs (6 records)
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO audit_logs (id, timestamp, actor, action, details, ip) VALUES
...
-- ------------------------------------------------------------------------------
-- 13. Estate Settings (1 record)
-- Using ON DUPLICATE KEY UPDATE to guarantee the singleton pattern (id = 1)
-- ------------------------------------------------------------------------------
